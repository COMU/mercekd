...
DATABASES = {
    'default': {
        ...
        'NAME': 'lease',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'jz@ry##8+kwo!8%vqs62a8=h0&amp;@&amp;3w=zf*t1!^sa=hjo@c#93#'
...
WSGI_APPLICATION = 'mercekdUI.wsgi.application'
